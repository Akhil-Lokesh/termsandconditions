...
RISK_PATTERNS: List[RiskPattern] = [
    ...
    # ---- HIGH / MEDIUM — added 2026-05-28 after recall-gap audit -------- #
    {
        "id": "dnt_signal_not_honored",
        "title": "Does not honor Do Not Track signals",
        "severity": "medium",
        "category": "surveillance",
        "description": "The service does not respond to browser Do Not Track (DNT) or Global Privacy Control (GPC) signals, so tracking continues even when the user has signalled they object.",
        "example": "Our Service does not respond to Do Not Track signals from your browser.",
        "aliases": ["do not track", "DNT", "Global Privacy Control", "GPC", "we do not respond to"],
    },
    {
        "id": "arbitration_delegation_clause",
        "title": "Arbitrator decides arbitrability (delegation)",
        "severity": "high",
        "category": "arbitration",
        "description": "A delegation clause gives the arbitrator — not a court — exclusive authority to decide whether a dispute is arbitrable and whether the arbitration agreement itself is valid or enforceable, stripping courts of even that threshold question.",
        "example": "The arbitrator shall have exclusive authority to resolve any dispute relating to the interpretation, applicability, enforceability, or formation of this arbitration agreement.",
        "aliases": ["delegation clause", "arbitrability", "enforceability of this arbitration", "formation of this agreement"],
    },
    {
        "id": "forced_arbitration_no_optout",
        "title": "Mandatory binding arbitration of disputes",
        "severity": "medium",
        "category": "arbitration",
        "description": "Disputes must be resolved through binding individual arbitration instead of court, even where no explicit class-action waiver is named. Removes the user's access to the courts.",
        "example": "Any dispute arising under these Terms shall be finally resolved by binding arbitration administered under the rules of the AAA.",
        "aliases": ["binding arbitration", "final and binding arbitration", "resolved by arbitration"],
    },
    {
        "id": "terms_change_duty_to_check",
        "title": "Changes effective on posting; duty to check",
        "severity": "medium",
        "category": "modification",
        "description": "Terms may change at any time and become effective on posting, with the user's only 'notice' being an obligation to periodically re-read the page. No direct or advance notice is given.",
        "example": "We may revise these Terms at any time. Changes are effective when posted, and you are responsible for checking this page periodically for updates.",
        "aliases": ["check this page", "review periodically", "effective when posted", "your responsibility to review"],
    },
    {
        "id": "virtual_goods_revocable",
        "title": "Paid virtual goods revocable at will",
        "severity": "medium",
        "category": "content",
        "description": "The company may modify, suspend, or eliminate purchased virtual goods, in-game items, or virtual currency at its sole discretion, so the user can lose assets they paid for.",
        "example": "We may modify, manage, or eliminate virtual currency or virtual goods at any time, with or without notice, and you will not be entitled to a refund.",
        "aliases": ["virtual currency", "virtual goods", "in-game items", "no real-world value"],
    },
    {
        "id": "browsewrap_assent",
        "title": "Agreement formed by mere use (browsewrap)",
        "severity": "medium",
        "category": "modification",
        "description": "The user is bound to the agreement simply by using or browsing the service, with no affirmative action (no checkbox or click-to-accept), raising notice and consent concerns.",
        "example": "By accessing or using the website, you agree to be bound by these Terms, whether or not you have read them.",
        "aliases": ["by using this site you agree", "by accessing", "continued use constitutes agreement"],
    },
    {
        "id": "unilateral_price_increase",
        "title": "Unilateral price or fee increase",
        "severity": "medium",
        "category": "payment",
        "description": "The company reserves the right to change prices or fees at any time, applying the new amount to ongoing subscriptions without meaningful consent beyond continued use.",
        "example": "We reserve the right to change our fees at any time. Continued use of the Service after a price change constitutes acceptance of the new price.",
        "aliases": ["change our fees", "modify pricing", "increase the price", "subject to change"],
    },
    {
        ...
        "severity": "medium",
        "category": "data",
        "description": "Personal data is transferred to and processed in other countries, potentially under weaker data-protection laws than the user's home jurisdiction.",
        "example": "Your information may be transferred to, stored, and processed in the United States and other countries that may not provide the same level of data protection as your country.",
        "aliases": ["transferred to other countries", "processed in the United States", "international transfer", "outside your country"],
    },
